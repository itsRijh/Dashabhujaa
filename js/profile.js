...
function deletePostProduct(event) {
    fetch('http://localhost:3500/products/delete', {
        method: 'POST',
        headers: {
...
function deletePostService(event) {
    ...
    fetch('http://localhost:3500/services/delete', {
        method: 'POST',
        headers: {
            "Content-Type": "application/json",
            Authorization: token,
...
fetch("http://localhost:3500/products/get", {
    method: "GET",
    headers: {
        "Content-Type": "application/json",
        Authorization: token,
...
fetch("http://localhost:3500/services/get", {
    method: "GET",
    headers: {
        "Content-Type": "application/json",
        Authorization: token,
...
fetch("http://localhost:3500/products/myinterest", {
    method: "GET",
    headers: {
        "Content-Type": "application/json",
        Authorization: token,
    ...
    .catch(err => {
        Swal.fire({
            icon: 'error',
            title: 'Oops..',
            text: 'Fetching failed. Contact us at Dashabhujaathome@gmail.com',
        })
    })

fetch("http://localhost:3500/services/myinterest", {
    method: "GET",
    headers: {
        "Content-Type": "application/json",
        Authorization: token,
...
fetch("http://localhost:3500/products/recinterest", {
    method: "GET",
    headers: {
        "Content-Type": "application/json",
        Authorization: token,
...
fetch("http://localhost:3500/services/recinterest", {
    method: "GET",
    headers: {
        "Content-Type": "application/json",
        Authorization: token,
